...
def jingbai_process(data):
    ...
    for x in range(0, rows):
        ...
        if ((combine[x, 0] > 33) and (combine[x, 2] >= 102) and (density_checking_switch > 530) and (density_checking_switch < 630)):
            # jb_count = jb_count + 1
            # AirOutTemp
            # if combine[x, 1] > 130 :
...
def jingbai_process_v2(data):
    ...
    for x in range(0, rows):
        ...
        if ((combine[x, 0] > 33) and (combine[x, 2] >= 100) and (density_checking_switch > 530) and (density_checking_switch < 660)):
