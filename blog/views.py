            ...
            json_body = [
                {
                    ...
                    "fields": {
                        ...
                        "pred_m" : round(float(serializer.data.get("f_m")), 2),
    ...
    for x in range(0, rows):
        ...
        if combine[x, 2] <= bpt:
            ...
            if abs(combine[x, 2] - bpt) >= 3.0:
                ...
                modified_res[x, 10] = combine[x, 10] + 1.3
                modified_res[x, 12] = combine[x, 12] + 7
                if combine[x, 11] > 28 and abs(combine[x, 2] - bpt) >= 4.5:
                    modified_res[x, 11] = combine[x, 11] - 1
            else:
            ...
            if density_checking_switch > 630:
                ...
                if combine[x, 0] >= 33 and combine[x, 0] < 34.5:
                    if abs(combine[x, 2] - bpt) >= 1.0:
                        modified_res[x] = -1
                        indicator = 2
                        if density_checking_switch < 615:
                        ...
                        if abs(combine[x, 2] - bpt) >= 5.5  and combine[x, 11] <= 38 and combine[x, 8] < 63 and density_checking_switch < 610:
                            modified_res[x, 11] = combine[x, 11] + 1
                            modified_res[x, 12] = combine[x, 12] - 5
                    # elif ((combine[x, 9] < 90) and  (combine[x, 10] < 88)):
                    #     indicator = 2
                    #     modified_res[x, 9] = round(combine[x, 9] + 4 * 0.2, 2)
                    #     modified_res[x, 10] = combine[x, 10] + 1.3
                    #     if  abs(combine[x, 2] - bpt) <= 1.0:
                ...
                if combine[x, 0] >= 34.5 and combine[x, 0] < 35:
                    if abs(combine[x, 2] - bpt) >= 2.0:
                        ...
                        if density_checking_switch < 615:
                            ...
                            modified_res[x, 12] = combine[x, 12] + 4.5
                        if abs(combine[x, 2] - bpt) >= 5.5  and combine[x, 11] <= 32 and combine[x, 8] < 63 and density_checking_switch < 615:
                            modified_res[x, 11] = combine[x, 11] + 1

                        if abs(combine[x, 2] - bpt) >= 5.5 and density_checking_switch < 615:
                            modified_res[x, 12] = combine[x, 12] - 4.5
                    # elif ((combine[x, 9] < 90) and  (combine[x, 10] < 88)):
                    #     indicator = 2
                    #     modified_res[x, 9] = round(combine[x, 9] + 4 * 0.2, 2)
                ...
                if combine[x, 0] >= 35 and combine[x, 0] < 36.5:
                    if abs(combine[x, 2] - bpt) >= 2.0:
                        modified_res[x] = -1
                        indicator = 2
                        if density_checking_switch < 615:
                ...
                if combine[x, 0] >= 36.5 and combine[x, 0] < 39:
                    if abs(combine[x, 2] - bpt) >= 2:
                        modified_res[x] = -1
                        indicator = 2
                        if density_checking_switch < 615:
                            modified_res[x, 12] = combine[x, 12] - 5
                ...
                if combine[x, 0] >= 39 and combine[x, 0] < 39.5:
                    if abs(combine[x, 2] - bpt) >= 3.5 and combine[x, 11] <= 38 and combine[x, 8] < 63:
                        modified_res[x] = -1
                        indicator = 2
                        if density_checking_switch < 615:
                            modified_res[x, 11] = combine[x, 11] + 1
                        ...
                        if abs(combine[x, 2] - bpt) > 4.5 and density_checking_switch < 600:
                            modified_res[x, 12] = combine[x, 12] - 6

                        if ((combine[x, 9] < 88.5) and  (combine[x, 10] < 87.5)):
                            indicator = 2
                            modified_res[x, 9] = round(combine[x, 9] + 4 * 0.2, 2)
                            modified_res[x, 10] = combine[x, 10] + 1.3
                            if  abs(combine[x, 2] - bpt) <= 4.5:
                                modified_res[x, 12] = combine[x, 12] + 4
                                if combine[x, 11] > 30 and combine[x, 8] > 58:
                                    modified_res[x, 11] = combine[x, 11] - 1
                    else:
                ...
                if combine[x, 0] >= 39.5 and combine[x, 0] < 40:
                    if abs(combine[x, 2] - bpt) >= 2.5:
                        ...
                        if density_checking_switch < 615:
                            ...
                            modified_res[x, 12] = combine[x, 12] + 4.5
                        if abs(combine[x, 2] - bpt) >= 5.5  and combine[x, 11] <= 35 and combine[x, 8] < 63 and density_checking_switch < 605:
                            modified_res[x, 11] = combine[x, 11] + 1
                            modified_res[x, 12] = combine[x, 12] - 4.5
                    elif ((combine[x, 9] < 88.5) and  (combine[x, 10] < 87.5)):
                        indicator = 2
                ...
                if combine[x, 0] >= 40 and combine[x, 0] < 40.5:
                    if abs(combine[x, 2] - bpt) >= 3.0:
                        modified_res[x] = -1
                        indicator = 2
                        # if ((combine[x, 9] > 66 and combine[x, 9] < 79) and (combine[x, 10] > 53 and combine[x, 10] < 87)):
                ...
                if combine[x, 0] >= 40.5 and combine[x, 0] < 41:
                    if abs(combine[x, 2] - bpt) >= 2.0 and combine[x, 11] <= 37 and  combine[x, 8] < 63 and density_checking_switch < 610:
                        modified_res[x] = -1
                        indicator = 2
                        modified_res[x, 11] = combine[x, 11] + 1

                        if abs(combine[x, 2] - bpt) >= 6.0 and density_checking_switch < 605:
                ...
                if combine[x, 0] >= 41 and combine[x, 0] < 41.5:
                    if abs(combine[x, 2] - bpt) >= 2.0:
                        modified_res[x] = -1
                        indicator = 2
                        if abs(combine[x, 2] - bpt) >= 4.0 and density_checking_switch < 605:
                            modified_res[x, 12] = combine[x, 12] - 9
                        elif density_checking_switch < 615:
                            modified_res[x, 12] = combine[x, 12] - 6
                        else:
                            modified_res[x, 12] = combine[x, 12] + 5
                    else:
                ...
                if combine[x, 0] >= 41.5:
                    if abs(combine[x, 2] - bpt) >= 2.0 and combine[x, 11] <= 38 and combine[x, 8] < 63:
                        modified_res[x] = -1
                        indicator = 2
                        if density_checking_switch < 610:
                            modified_res[x, 11] = combine[x, 11] + 1
                        else:
                            modified_res[x, 12] = combine[x, 12] + 4.5
                        if abs(combine[x, 2] - bpt) >= 5.0 and density_checking_switch < 610:
                            modified_res[x, 12] = combine[x, 12] -  7.0
                    else:
                        modified_res[x] = -1
                        indicator = 2
                        modified_res[x, 12] = combine[x, 12] + 4.5
                        if combine[x, 11] >= 28 and combine[x, 8] > 58:
                            modified_res[x, 11] = combine[x, 11] - 1
                    return modified_res, indicator
    return modified_res, indicator
...
def jingbai_process(data):
    ...
    for x in range(0, rows):
        ...
        #     if combine[x, 2] <= 115 and modified_res[x, 9] == -1 and modified_res[x, 10] == -1:
        #         modified_res[x, 12] = combine[x, 12] + 7
        ...
        #     # jb_tmp = modified_res
        # # modified_res = jb_tmp
        # elif combine[x, 2] < 115 and combine[x, 8] > 59:
        #     modified_res[x] = -1
        #     indicator = 2
        #     modified_res[x, 10] = combine[x, 10] + 1.3
        #     modified_res[x, 9] = round(combine[x, 9] + 4 * 0.2, 2)
        ...
        if combine[x, 2] < bpt   and modified_res[x, 12] == -1 and indicator != -3:
            modified_res[x] = -1
            indicator = 2
            modified_res[x, 12] = combine[x, 12] + 6
            
        
        if combine[x, 2] >= bpt and combine[x, 8] > 58 and density_checking_switch < 630 and indicator != -3:
            modified_res[x] = -1
            indicator = 2
            modified_res[x, 12] = combine[x, 12] - 7 
        ...
        if density_checking_switch < 630 and combine[x, 2] >= bpt  and combine[x, 11] >= 34 and  modified_res[x, 12] == -1 and indicator != -3:
            modified_res[x] = -1
            indicator = 2
            modified_res[x, 12] = combine[x, 12] - 7
